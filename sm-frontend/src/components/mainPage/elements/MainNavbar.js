            ...
            <Flex flexDir="row" w="100%" minH="14vh" maxH="14vh" alignItems="center">
                ...
                <Flex flexDir="row" minW="20vw" maxW="100vw" maxH="20vh" mr="1%">
                    {props.activePage === "note" &&
                        <>
                        <Button bg="#333" color='white' _hover={{ bg: "#555"}}  onClick={() => props.setActivePage("todo")} size="large" minW="8vw">Check ToDos</Button>
                        </>
                    }
                    {props.activePage === "todo" &&
                        <>
                        <Button bg="#333" color='white' _hover={{ bg: "#555"}}  onClick={() => props.setActivePage("note")} size="large" minW="8vw">Return to notes</Button>
                        </>
                    }
